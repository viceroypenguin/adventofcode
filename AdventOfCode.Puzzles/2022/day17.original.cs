...
public partial class Day_17_Original : IPuzzle
{
	...
	{
		(3, 0, new() { (0, 0), (1, 0), (2, 0), (3, 0), }),
		(2, 2, new() { (1, 0), (0, 1), (1, 1), (1, 2), (2, 1), }),
		(2, 2, new() { (0, 0), (1, 0), (2, 0), (2, 1), (2, 2), }),
		(0, 3, new() { (0, 0), (0, 1), (0, 2), (0, 3), }),
		(1, 1, new() { (0, 0), (0, 1), (1, 0), (1, 1), }),
	};
	...
	private class State : IEquatable<State>
	{
		...
		public List<byte[]> FallenRocks { get; } = new();
		...
		public byte[] JetPattern { get; set; } = Array.Empty<byte>();
